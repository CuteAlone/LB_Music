...
OWNER_ID = int(getenv("OWNER_ID", "1128943556"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/AloneCheatsOP")
SUPPORT_CHAT = getenv("SUPPORT_GROUP", "https://t.me/+YT_TT-35Ji1mN2Q9")
